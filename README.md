...
- [SRE Observability & RED Metrics Dashboard](#-sre-observability--red-metrics-dashboard)
...
flowchart TD
    subgraph Host ["Local Host Machine ($0 Cloud Cost)"]
        ...
        Client -->|Port 30000| GrafanaUI[Grafana Dashboards]
...
- **Turnkey SRE Observability:** Pre-configured `kube-prometheus-stack` with Google Golden Signals / RED metrics dashboards and production Alertmanager rules.
...
# Bootstrap the complete platform (Kind, Ingress, ArgoCD, Apps, Prometheus, Grafana)
make up
```
...
| **Grafana SRE Dashboards** | `http://localhost:30000` | `admin` / `admin` | RED metrics & cluster telemetry |
...
## 📊 SRE Observability & RED Metrics Dashboard
